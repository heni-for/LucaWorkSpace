  ...
  return (
    <PublicRoute>
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">Join thousands of users already using Luca</p>
      </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`auth-input pl-10 ${errors.firstName ? 'border-red-300 focus:ring-red-500' : ''}`}
                placeholder="John"
                disabled={isLoading}
              />
            </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleInputChange}
                className={`auth-input pl-10 ${errors.lastName ? 'border-red-300 focus:ring-red-500' : ''}`}
                placeholder="Doe"
                disabled={isLoading}
              />
            </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              onChange={handleInputChange}
              className={`auth-input pl-10 pr-10 ${errors.confirmPassword ? 'border-red-300 focus:ring-red-500' : ''}`}
